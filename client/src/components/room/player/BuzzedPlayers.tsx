...
const BuzzedPlayers = () => {
  ...
  return (
    <div className="flex min-h-[25rem] flex-col gap-4 rounded-md border border-gray-100  bg-rose-300 bg-opacity-30 bg-clip-padding px-10 py-6 shadow-2xl backdrop-blur-sm backdrop-filter sm:row-span-3">
