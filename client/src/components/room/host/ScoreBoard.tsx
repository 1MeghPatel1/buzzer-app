...
const ScoreBoard = () => {
  ...
  return (
    <div className="col-start-1 row-span-1 row-start-2 min-h-[40.5rem]  rounded-md border border-gray-100 bg-violet-300  bg-opacity-30 bg-clip-padding px-10 py-6 shadow-2xl backdrop-blur-sm backdrop-filter md:col-start-2 md:row-start-1 lg:col-start-3 lg:row-span-full">
